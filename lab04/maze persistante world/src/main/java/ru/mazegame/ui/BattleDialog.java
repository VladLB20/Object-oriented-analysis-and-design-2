...
public class BattleDialog extends JDialog {
    ...
    public enum BattleResult {
        IN_PROGRESS, PLAYER_WON, PLAYER_DIED
    }
    ...
    public BattleDialog(JFrame parent, Player player, Enemy enemy,
        ...
        attackButton.addActionListener(this::performAction);
    ...
    private void performAction(ActionEvent e) {
        ...
        if (selected.equals("Обычная атака")) {
            ...
            if (usedSkill != null) {
                ...
                int heal = usedSkill.getHealAmount();
                enemy.takeDamage(damage);
                if (damage > 0) {
                ...
                if (heal > 0) {
                    player.heal(heal);
                    logArea.append("Вы восстанавливаете " + heal + " здоровья.\n");
                }
